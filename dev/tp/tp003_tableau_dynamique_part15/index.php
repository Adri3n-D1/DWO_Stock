<!-- TO DO
Finir la fonction analysisData() : ajax.js -> analysisData
- Vérifier si les données sont valides ou non

Revoir l'enregistrement de l'image : upload_img.php
- les images ne sont enregistrées que si leur extension est (png, svg, jpeg, gif)
- l'enregistrement doit se faire dans un dossier img
- l'image doit être enregistrée sous un nom unique
--> 
