...
<head>
    ...
    <title>Exo 315 - compte</title>
</head>
<body>

    <form action="exo315_ajoututilisateur.php" method="POST" class="container">
        <div class="mb-3">
            <label for="form-nom" class="form-label">Nom</label>
            <input type="text" class="form-control" id="form-nom" name="form-nom" required maxlength="40">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="form-naissance" name="form-naissance" required min="1950" max="2005">
        </div>
        <select class="form-select"  name="form-role" required>
        ...
        <div class="mb-3">
            ...
            <input type="password" class="form-control" id="form-password" name="form-password" pattern="^[A-Za-z0-9!@#$%&*\-_+,.?]{12,}$">
        </div>
